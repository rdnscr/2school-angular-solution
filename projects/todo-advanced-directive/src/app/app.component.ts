...
@Component({
    ...
    standalone: true,
    imports: [MatSidenavModule, MatIconModule, MatListModule, MatSidenavModule, FlexLayoutModule, RouterLink, NgFor, RouterLinkActive, MatToolbarModule, RouterOutlet]
})
